        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValueSql: "(N'Photo.jpg')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "float", nullable: true, defaultValueSql: "((0))"),
                    Image = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValueSql: "(N'Product.jpg')"),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: true),
                    SupplierId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValueSql: "(N'TT')"),
                    Quantity = table.Column<int>(type: "int", nullable: true, defaultValueSql: "((100))"),
                    Discount = table.Column<double>(type: "float", nullable: true, defaultValueSql: "(rand())"),
                    Special = table.Column<bool>(type: "bit", nullable: true),
